...
tramwayFootprintsShapes <- readOGR(dsn = 'D:/New_Mexico/JOR_Tramway_Project', layer = "TramwayMeasurementFootprintShapesNew")
...
seqOwnPanelNDVI <- raster("D:/New_Mexico/JOR_Tramway_Project/ReflStacks/TRM_2_SEQ/ownPanel/indices/TRM_2_SEQ_proj2lines_index_ndvi.tif")
seqOwnPanelNDVICrop <- crop(seqOwnPanelNDVI,tramwayROI)

seqSpectralonReflStackCrop <- stack("D:/New_Mexico/JOR_Tramway_Project/ReflStacks/TRM_2_SEQ/Spectralon/TRM_2_SEQ_proj2lines_SpectralonRefl_stackcrop.tif")
seqSpectralonNDVI <- raster("D:/New_Mexico/JOR_Tramway_Project/ReflStacks/TRM_2_SEQ/Spectralon/indices/TRM_2_SEQ_proj2lines_index_ndvi.tif")
seqSpectralonNDVICrop <- crop(seqSpectralonNDVI,tramwayROI)

seqELMReflStackCrop <- stack("D:/New_Mexico/JOR_Tramway_Project/ReflStacks/TRM_2_SEQ/ELM/TRM_2_SEQ_proj2lines_ELSEQfl_stackcrop.tif")
seqELMNDVI <- raster("D:/New_Mexico/JOR_Tramway_Project/ReflStacks/TRM_2_SEQ/ELM/indices/TRM_2_SEQ_proj2lines_ELMindex_ndvi.tif")
...
MREOwnPanelNDVI <- raster("D:/New_Mexico/JOR_Tramway_Project/ReflStacks/TRM_2_MRE/ownPanel/indices/TRM_2_MRE_proj2lines_index_ndvi.tif")
MREOwnPanelNDVICrop <- crop(MREOwnPanelNDVI,tramwayROI)

MRESpectralonReflStackCrop <- stack("D:/New_Mexico/JOR_Tramway_Project/ReflStacks/TRM_2_MRE/Spectralon/TRM_2_MRE_proj2lines_SpectralonRefl_stackcrop.tif")
...
MRESpectralonNDVI <- raster("D:/New_Mexico/JOR_Tramway_Project/ReflStacks/TRM_2_MRE/Spectralon/indices/TRM_2_MRE_proj2lines_index_ndvi.tif")
MRESpectralonNDVICrop <- crop(MRESpectralonNDVI,tramwayROI)

MREELMReflStackCrop <- stack("D:/New_Mexico/JOR_Tramway_Project/ReflStacks/TRM_2_MRE/ELM/TRM_2_MRE_proj2lines_ELMRefl_stackcrop.tif")
MREELMNDVI <- raster("D:/New_Mexico/JOR_Tramway_Project/ReflStacks/TRM_2_MRE/ELM/indices/TRM_2_MRE_proj2lines_ELMindex_ndvi.tif")
...
secondRunFwdMREresampSpectra <- read.csv("D:/New_Mexico/JOR_Tramway_Project/Tram_data/Resamp_reflectance/eventdata-2020-02-24-SecondRunForward_REMResamp.csv")

secondRunBkdSeqresampSpectra <- read.csv("D:/New_Mexico/JOR_Tramway_Project/Tram_data/Resamp_reflectance/eventdata-2020-02-24-SecondRunBackward_SeqResamp.csv")
...
#seqFootprintNDVI <- extract(seqOwnPanelNDVICrop,tramwayFootprintsShapes,fun=mean,df=TRUE)
...
seqFootprintNDVI <- extract(seqSpectralonNDVICrop,tramwayFootprintsShapes,fun=mean,df=TRUE)
...
lines(1:110, seqFootprintNDVI$TRM_2_SEQ_proj2lines_index_ndvi,col='red')
...
x <- as.vector(secondRunBkdSeqresampNDVI)
y <- as.vector(seqFootprintNDVI$TRM_2_SEQ_proj2lines_index_ndvi)
df <- data.frame(x = x, y = y,
                 d = densCols(x, y, colramp = colorRampPalette(rev(c('yellow','orange','turquoise4','dodgerblue4')))))#colorRampPalette(rev(rainbow(10, end = 4/6)))))
