...
#----5. Sample tramway spectra data and NDVI----
...
#----6. Extract reflectance mean for Tramway Footprints----
...
title("Sequioa Own Panel - Tramway Second Run Back")

#SEQ Spectralon 2nd run Bk
plot(1:110, secondRunBkdSeqresampNDVI,type='n',xlab='[m]',ylab='NDVI')
lines(1:110, secondRunBkdSeqresampNDVI,col='black')
lines(1:110, seqFootprintSpectralonNDVI$TRM_2_SEQ_proj2lines_index_ndvi,col='red')
legend(20, 0.4, legend=c("Tramway Spectrometer NDVI", "Sequoia NDVI"),
       lty=c(1,1),col=c('black','red'),box.lty=0,y.intersp=1,x.intersp=1,bg="transparent",xpd=TRUE)
title("Sequioa Spectralon - Tramway Second Run Back")

#SEQ Spectralon 2nd run Forwards
plot(1:110, SecondRunFwdSeqresampNDVI,type='n',xlab='[m]',ylab='NDVI')
lines(1:110, SecondRunFwdSeqresampNDVI,col='black')
lines(1:110, seqFootprintSpectralonNDVI$TRM_2_SEQ_proj2lines_index_ndvi,col='red')
legend(20, 0.4, legend=c("Tramway Spectrometer NDVI", "Sequoia NDVI"),
       lty=c(1,1),col=c('black','red'),box.lty=0,y.intersp=1,x.intersp=1,bg="transparent",xpd=TRUE)
title("Sequioa Spectralon - Tramway Second Run Forwards")

#MRE Spectralon 2nd run forwards
...
legend(20, 0.6, legend=c("Tramway Spectrometer NDVI", "MRE NDVI"),
       lty=c(1,1),col=c('black','red'),box.lty=0,y.intersp=1,x.intersp=1,bg="transparent",xpd=TRUE)
title("MRE Spectralon - Tramway Second Run Forwards")

#MRE Spectralon 2nd run Bkwds
plot(1:110, secondRunBkdMREresampNDVI,ylim=c(0,0.6),type='n',xlab='[m]',ylab='NDVI')
lines(1:110, secondRunBkdMREresampNDVI,col='black')
lines(1:110, MREFootprintNDVI$TRM_2_MRE_proj2lines_index_ndvi ,col='red')
legend(20, 0.6, legend=c("Tramway Spectrometer NDVI", "MRE NDVI"),
       lty=c(1,1),col=c('black','red'),box.lty=0,y.intersp=1,x.intersp=1,bg="transparent",xpd=TRUE)
title("MRE Spectralon - Tramway Second Run Back")
